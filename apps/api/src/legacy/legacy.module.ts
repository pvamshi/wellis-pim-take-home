...
import { LegacyConsentRule, LegacyIntakeRule, LegacyPatientRule } from './legacy-rule.entity';

/**
 * The six legacy tables — two per source, a data table and the rule rows found
 * against it.
 *
 ...
 *
 * `TypeOrmModule` is re-exported so the six repositories are injectable from
